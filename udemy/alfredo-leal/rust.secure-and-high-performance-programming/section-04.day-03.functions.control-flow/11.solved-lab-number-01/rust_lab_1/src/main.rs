fn main() {
    ...
    let product_name: String = String::from("Laptop");
    let mut price: f32 = 1200.50; // Precio en dólares
    let quantity: u32 = 5;
    ...
    if on_sale {
        // Si está en oferta, reducir el precio en un 10%
        price *= 0.9;
        total_value = price * quantity as f32;
    }
